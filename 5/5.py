...
train_dataset = torchvision.datasets.ImageFolder(
    root=r'E:\нейронки_РОМАН\5\data\train',
    transform=data_transforms
)

test_dataset = torchvision.datasets.ImageFolder(
    root=r'E:\нейронки_РОМАН\5\data\test',
    transform=data_transforms
)
...
train_dataset = torchvision.datasets.ImageFolder(root=r'E:\нейронки_РОМАН\5\data\test',
                                                 transform=data_transforms)
test_dataset = torchvision.datasets.ImageFolder(root=r'E:\нейронки_РОМАН\5\data\train',
                                             transform=data_transforms)
...
new_classifier.add_module('fc',nn.Linear(4096,num_classes))# добавляем последним слой с тремя нейронами на выходе
